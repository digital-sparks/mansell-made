(() => {
  ...
  window.Webflow ||= [];
  window.Webflow.push(() => {
    gsapWithCSS.to(document.querySelector(".full-screen-hero_component img"), {
      yPercent: 20,
      filter: "blur(5px)",
      ease: "linear",
      scrollTrigger: {
    ...
    gsapWithCSS.from(".next-project_component .heading-size-small", {
      yPercent: 25,
      duration: 0.6,
      opacity: 0,
      ease: "power1.out",
    ...
    document.querySelectorAll(".work-item_component").forEach((item) => {
      ...
      gsapWithCSS.set(backgroundImage, {
